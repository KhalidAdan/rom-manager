...
INSERT INTO "new_games" ("coverArt", "created_at", "file", "id", "releaseDate", "summary", "system_id", "title", "updated_at") SELECT "coverArt", "created_at", "file", "id", "releaseDate", "summary", "system_id", "title", "updated_at" FROM "games";
DROP TABLE "games";
